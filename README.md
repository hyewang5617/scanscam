...
5. Sepolia 테스트넷 ETH가 없다면 [Sepolia Faucet](https://sepoliafaucet.com)에서 무료로 받을 수 있어요
6. Deploy 클릭 → 배포된 컨트랙트 주소를 GitHub README나 기획서에 기재하면 "실제 온체인에 배포됨"이라는 근거가 됩니다
